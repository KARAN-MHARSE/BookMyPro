...
public class CreateCredentialController {
	...
	public ResponseEntity<CreateCredentialResponse> register(@Valid @RequestBody CreateCredentialRequest request) {

		CreateCredentialResponse response = createCredentialService.createCredential(request);
